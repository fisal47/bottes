...
*き⃟🍂 ${prefix}ceksewa*
*き⃟🍂 ${prefix}welcome* _enable/disable_
*き⃟🍂 ${prefix}antilink* _enable/disable_
*き⃟🍂 ${prefix}kickall*
*き⃟🍂 ${prefix}infogrup*
*き⃟🍂 ${prefix}promote*
...
*き⃟🍂 ${prefix}pornhub* _teks_
*き⃟🍂 ${prefix}blackpink* _teks_
*き⃟🍂 ${prefix}natural* _teks_
...
𝐏𝐄𝐍𝐃𝐈𝐃𝐈𝐊𝐀𝐍 𝐌𝐄𝐍𝐔
*き⃟🍂 ${prefix}nuliskiri* _teks_
*き⃟🍂 ${prefix}nuliskanan* _teks_
*き⃟🍂 ${prefix}foliokiri* _teks_
*き⃟🍂 ${prefix}foliokanan* _teks_
*き⃟🍂 ${prefix}brainly* _teks_
...
*き⃟🍂 ${prefix}tourl*
*き⃟🍂 ${prefix}tinyurl*
*き⃟🍂 ${prefix}bilangangka*
*き⃟🍂 ${prefix}artimimpi*
*き⃟🍂 ${prefix}resepmasakan*
*き⃟🍂 ${prefix}darkjoke*
*き⃟🍂 ${prefix}meme*
*き⃟🍂 ${prefix}quotesbucin*
*き⃟🍂 ${prefix}quotesmuslim*
*き⃟🍂 ${prefix}quoteskanye*
...
dha.sendMessage(from, loli, image, {quoted: mek})
break
case 'neko':
reply(mess.wait)
...
case 'nuliskiri':
    ...
    reply(mess.wait)
    ini_result = await getBuffer(`https://hardianto.xyz/api/nuliskiri?text=${q}&apikey=hardianto`)
    dha.sendMessage(from, ini_result, image, {quoted: mek, caption: 'Awas ketahuan kak :v'})
    break
    case 'nuliskanan':
    if (!q) return reply('Textnya mana kak?')
    reply(mess.wait)
...
dha.sendMessage(from, p, video, { quoted:  mek, mimetype: 'video/mp4', caption: 'ASUPAN NYA KAK'})
break
case 'darkjoke':
reply(mess.wait)
...
case 'quotesmuslim':
reply(mess.wait)
mus = await fetchJson(`https://api-indonesia-devolopers.herokuapp.com/randomquote/muslim`)
reply(mus.result.text_id)
break
case 'quoteskanye':
reply(mess.wait)
sal = await fetchJson(`https://api-indonesia-devolopers.herokuapp.com/quotes/kanye`)
reply(sal.result.text_id)
break
        case 'nulis':
        case 'tulis':
...
case 'tahta':
    if (!q) return reply('Textnya mana kak?')
    reply(mess.wait)
    anto = await getBuffer(`https://hardianto.xyz/api/harta?query=${q}&apikey=hardianto`)
    dha.sendMessage(from, anto, image, {quoted: mek, caption: 'Nih kak'})
    break
case 'pornhub':
    reply(mess.wait)
    ...
    txt1 = args[0]
    txt2 = args[1]
    ini_url = await fetchJson(`https://hardianto.xyz/api/textpro/porn-hub?apikey=hardianto&text1=${txt1}&text2=${txt2}`)
    ini_url = ini_url.result
    ini_buffer = await getBuffer(ini_url)
    await dha.sendMessage(from, ini_buffer, image, { quoted: mek })
    break
    ...
    if (!q) return reply('Textnya mana kak?')
    reply(mess.wait)
    ini_url = await fetchJson(`https://hardianto.xyz/api/textpro/black-pink?apikey=hardianto&text=${q}`)
    ini_url = ini_url.result
    ini_buffer = await getBuffer(ini_url)
    await dha.sendMessage(from, ini_buffer, image, { quoted: mek })
    break
    ...
    if (!q) return reply('Textnya mana kak?')
    reply(mess.wait)
    ini_url = await fetchJson(`https://hardianto.xyz/api/textpro/natural-leaves?apikey=hardianto&text=${q}`)
    ini_url = ini_url.result
    ini_buffer = await getBuffer(ini_url)
    await dha.sendMessage(from, ini_buffer, image, { quoted: mek })
    break
